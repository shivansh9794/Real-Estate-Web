...
const contactUs = () => {
    return (
        <div className='py-2 w-full'>
                ...
                <div class="mx-auto w-full  gap-2 sm:px-6 lg:px-8">

                    <div class="grid lg:grid-cols-2 grid-cols-1 gap-5">

                        <div class="lg:mb-0 mb-10 z-0 col-span-1">
                            ...
                            <div class="w-full h-full">
                                ...
                                <div class="relative h-full">
                                    ...
                                    class="w-full h-full lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-indigo-300 object-cover" />
                                    ...
                                    <div class="absolute bottom-0 w-full lg:p-11 p-5">
                                        <div class="bg-white rounded-lg p-6 block">
                                            <a href="javascript:;" class="flex items-center mb-6">
                                                ...
                                                <h5 class="text-black text-base font-normal leading-6 ml-5">9336982500</h5>
                                            </a>
                                            <a href="javascript:;" class="flex items-center mb-6">
                                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <h5 class="text-black text-base font-normal leading-6 ml-5">reSide7@gmail.com</h5>
                                            </a>
                                            <a href="javascript:;" class="flex items-center">
                                                ...
                                                <h5 class="text-black text-base font-normal leading-6 ml-5">Matiyari Avenue, Lucknow, Up 225409</h5>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="bg-neutral-100 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl ">
                            <h2 class="text-indigo-600 font-manrope text-4xl font-semibold leading-10 mb-11">Send Us A Message</h2>
                            <input type="text" class="w-full h-12 text-gray-900 placeholder-gray-800  shadow-sm bg-transparent text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none pl-4 mb-10" placeholder="Name" />
                            <input type="text" class="w-full h-12 text-gray-900 placeholder-gray-800 shadow-sm bg-transparent text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none pl-4 mb-10" placeholder="Email" />
                            <input type="text" class="w-full h-12 text-gray-900 placeholder-gray-800 shadow-sm bg-transparent text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none pl-4 mb-10" placeholder="Phone" />
                            <div class="mb-10">
                                <h4 class="text-gray-800 text-lg font-semibold leading-7 mb-4">Preferred method  of communication</h4>
                                <div class="flex">
                                    <div class="flex items-center mr-11">
                                        ...
                                        <label htmlFor="radio-group-1" class="flex items-center cursor-pointer text-gray-900 text-base font-normal leading-6">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <label for="radio-group-2" class="flex items-center cursor-pointer text-gray-900 text-base font-normal leading-6">
