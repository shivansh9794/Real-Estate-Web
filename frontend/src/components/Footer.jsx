...
const Footer = () => {
    return (
        <div>
            {/* ========== FOOTER ========== */}
            <footer className="relative overflow-hidden bg-gray-300">
                <svg
                ...
                <div className="relative z-10">
                    <div className="w-full max-w-5xl px-4 xl:px-0 py-10 lg:pt-16 mx-auto">
                        <div className="inline-flex items-center">
                            {/* Logo */}
                            <h1 className='font-bold text-6xl pb-6 text-black'>reSide</h1>
                            {/* End Logo */}
                            <div className="border-s  ps-5 ms-5">
                                <p className="text-lg font-semibold  text-black">2024 Reside Co.</p>
                            </div>
                        </div>
                    </div>
                </div>
